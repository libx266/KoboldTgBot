...
namespace KoboldTgBot.Migrations
{
    ...
    [Migration("20240619014931_UpdateRoleCharacter")]
    partial class UpdateRoleCharacter
    {
            ...
            modelBuilder.Entity("KoboldTgBot.Database.DbRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = "женский",
                            InsertDate = new DateTime(2024, 6, 19, 1, 49, 31, 236, DateTimeKind.Utc).AddTicks(6989),
                            Name = "Erika",
                        ...
                        new
                        {
                            ...
                            Gender = "женский",
                            InsertDate = new DateTime(2024, 6, 19, 1, 49, 31, 236, DateTimeKind.Utc).AddTicks(6992),
                            Name = "Erika",
                        ...
                        new
                        {
                            ...
                            Gender = "женский",
                            InsertDate = new DateTime(2024, 6, 19, 1, 49, 31, 236, DateTimeKind.Utc).AddTicks(6993),
                            Name = "Erika",
